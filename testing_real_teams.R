...
men_df$usa_team <-men_df$Country == "USA"
men_df$usa_team <- men_df$usa_team + (men_df$FirstName == "FREDERICK") + (men_df$LastName == "RICHARD")
men_df$usa_team <- men_df$usa_team + (men_df$FirstName == "BRODY") + (men_df$LastName == "MALONE")
men_df$usa_team <- men_df$usa_team + (men_df$FirstName == "PAUL") + (men_df$LastName == "JUDA")
men_df$usa_team <- men_df$usa_team + (men_df$FirstName == "ASHER") + (men_df$LastName == "HONG")
men_df$usa_team <- men_df$usa_team + (men_df$FirstName == "STEPHEN") + (men_df$LastName == "NEDOROSCIK")
men_df <- men_df[men_df$usa_team != 1, ]
men_df <- subset(men_df, select = -usa_team)
...
women_df$usa_team <-women_df$Country == "USA"
women_df$usa_team <- women_df$usa_team + (women_df$FirstName == "SIMONE") + (women_df$LastName == "BILES")
women_df$usa_team <- women_df$usa_team + (women_df$FirstName == "SUNISA") + (women_df$LastName == "LEE")
women_df$usa_team <- women_df$usa_team + (women_df$FirstName == "JADE") + (women_df$LastName == "CAREY")
women_df$usa_team <- women_df$usa_team + (women_df$FirstName == "JORDAN") + (women_df$LastName == "CHILES")
women_df$usa_team <- women_df$usa_team + (women_df$FirstName == "LEANNE") + (women_df$LastName == "WONG")
women_df <- women_df[women_df$usa_team != 1, ]
women_df <- subset(women_df, select = -usa_team)
